...
public class PlayerMove : MonoBehaviour
{
    ...
    public void jump(InputAction.CallbackContext context)
    {
        ...
        if(context.performed && wallJumpTimer >0f)
        {
            ...
            Invoke(nameof(CancelWallJump), wallJumpTime + 0.1f); //Wall Jump = 0.05f -- Jump again = 0.06f
        }
    }

    private void GroundCheck()
    {
        if (Physics2D.OverlapBox(groundCheckPos.position, groundCheckSize, 0, groundLayer)) //check if set box overlaps with ground
        {
